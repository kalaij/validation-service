...
public class BlankValidationResultMaps {
    ...
    private static final List<ValidationAuthor> SAMPLE_VALIDATION_SERVICES_REQUIRED = Arrays.asList(ValidationAuthor.Biosamples, ValidationAuthor.Ena, ValidationAuthor.Core, ValidationAuthor.Taxonomy);
    private static final List<ValidationAuthor> STUDY_VALIDATION_SERVICES_REQUIRED = Arrays.asList(ValidationAuthor.Core, ValidationAuthor.Ena);
    private static final List<ValidationAuthor> ASSAY_VALIDATION_SERVICES_REQUIRED = Arrays.asList(ValidationAuthor.Core, ValidationAuthor.Ena);
