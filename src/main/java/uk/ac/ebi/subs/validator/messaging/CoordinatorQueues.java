...
public class CoordinatorQueues {
    ...
    public static final String SUBMISSION_PROJECT_VALIDATOR = "usi-submission-project-validator";
    ...
    public static final String SUBMISSION_SUBMITTABLE_DELETED = "usi-submittable-deletion";
}
